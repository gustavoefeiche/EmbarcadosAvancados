...
int main(int argc, char **argv) 
{
  ...
  // 
  uint32_t *gpio1_swporta_ddr_addr = (uint32_t *)(virtual_base + ((uint32_t)(ALT_GPIO1_SWPORTA_DDR_ADDR) & (uint32_t)(HW_REGS_MASK)));
  uint32_t *gpio1_swporta_dr_addr  =(uint32_t *)(virtual_base + ((uint32_t)(ALT_GPIO1_SWPORTA_DR_ADDR) & (uint32_t)(HW_REGS_MASK )));
  uint32_t *gpio1_porta_ext_addr   =(uint32_t *)(virtual_base + ((uint32_t)(ALT_GPIO1_EXT_PORTA_ADDR) & (uint32_t)(HW_REGS_MASK) ));
